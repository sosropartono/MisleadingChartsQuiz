...
`;
  ...
  ( 'Politics, Governments & Events 3', 'Mexico', '["pge3-mex-eng.png", "pge3-mex-esp.png"]', '[
    ...
    [
        "Hurricane Lidia strengthens into major hurricane as it approaches Puerto Vallarta along Mexico''s Pacific coaseatening a stretch of the west-central shoreline home to Puerto Vallarta, a resort town and popular tourist destination in the Mexican state of Jalisco. Its expected arrival comes on the heels of Tropical Storm Max, which hit the southern coast of Mexico on Monday, several hundred miles from Jalisco, before tapering off."
    ],
    [
